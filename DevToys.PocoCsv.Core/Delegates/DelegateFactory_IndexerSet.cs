...
namespace Delegates
{
    ...
    internal static partial class DelegateFactory
    {
        ...
        public static System.Action<object, TIndex, TIndex2, TIndex3, TValue> IndexerSet<TValue, TIndex, TIndex2, TIndex3>(this Type source)
        {
            var indexType = typeof(TIndex);
            var indexType2 = typeof(TIndex2);
            var indexType3 = typeof(TIndex3);
            return DelegateIndexerSet<System.Action<object, TIndex, TIndex2, TIndex3, TValue>>
        ...
        /// <typeparam name="TIndex3">Third index parameter type</typeparam>
        /// <returns>Delegate for indexer set accessor with three indexes</returns>
        public static System.Action<TSource, TIndex, TIndex2, TIndex3, TValue> IndexerSet
            <TSource, TValue, TIndex, TIndex2, TIndex3>()
        {
            ...
            return propertyInfo?.SetMethod?.CreateDelegate<System.Action<TSource, TIndex, TIndex2, TIndex3, TValue>>();
        }
